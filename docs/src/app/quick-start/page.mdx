...
**Results are capped** — Search returns max 25 results, formulas max 50, comments max 20. Always check the `truncated` field in the response and narrow your query if it is `true`.
