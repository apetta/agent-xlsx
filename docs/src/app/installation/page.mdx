...
- `agent-xlsx write <file> "A1" "value"` — write values
```
...
Full command reference: https://agent-xlsx.dev/commands
```

### MCP Tool Server

agent-xlsx returns JSON to stdout, making it easy to wrap as an MCP tool:
